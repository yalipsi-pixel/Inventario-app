...
# 1. RESTAURACIÓN DEL LOGO
# Asegúrate de tener el archivo de tu logo (ej: "logo.png" o "logo.jpg") en la misma carpeta que este app.py
ruta_logo = "logo.png" 
if os.path.exists(ruta_logo):
    st.image(ruta_logo, width=250)
else:
    st.warning("⚠️ No se encontró el archivo 'logo.png'. Por favor, colócalo en la misma carpeta para visualizarlo.")
...
with tab1:
    ...
    with st.form("form_movimiento"):
        ...
        with col1:
            ...
            # 2. CORRECCIÓN DE UNIDADES DE MEDIDA (Se eliminó "teniente")
        ...
        if submit_btn:
            if not producto.strip():
                ...
                # 2. Actualizar Inventario Actual
                ...
                st.rerun() # Recarga la app para mostrar los nuevos datos
...
with tab2:
    ...
    if df_inv.empty:
        ...
        # Formato para que los números se vean limpios
